...
<html>
  ...
  <body>
    ...
    <p>
      Number of imags to display before script ends. 
      <br />
      <input type="text" id="number" value="5"> more than 10 can take a long time
      <br />
      <button id="random">
        Show me random imgur ANIMATED pics!
      </button>
    </p>
